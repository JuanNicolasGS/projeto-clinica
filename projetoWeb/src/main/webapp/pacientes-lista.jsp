...
<%@page import="com.clinica.util.CPFUtil"%>
        ...
        <div class="form-container" style="max-width: 900px;">
            ...
            <form action="${pageContext.request.contextPath}/BuscarPaciente"
                ...
                <button type="submit"
                        ...
                        style="width: auto; margin: 0; padding: 0 25px;">
                    Buscar
                </button>
            </form>
                        ...
                        <td>
                            <%= CPFUtil.formatar(
                                ((com.clinica.model.Paciente)pageContext
                                    .getAttribute("p")).getCpf()
                            ) %>
                        </td>

                        <td class="action-links">
                            <a href="EditarPaciente?cpf=${p.cpf}"
                            class="button btn-info btn-mini">
                                Editar
                            </a>

                            <a href="pacientes-remover.jsp?cpf=${p.cpf}"
                            class="button btn-danger btn-mini">
                                Excluir
                            </a>
                        </td>
                    </tr>
